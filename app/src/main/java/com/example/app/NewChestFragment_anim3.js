...
const newFunc = `private fun startIdleAnimation() {
        ...
        when (currentRarity) {
            ...
            ChestRarity.EPIC -> {
                ...
                // Saat yönü ve tersi sallanma (2D titreşim)
                val ry0 = Keyframe.ofFloat(0f, 0f)
                val ry1 = Keyframe.ofFloat(0.26f, 0f)
                val ry2 = Keyframe.ofFloat(0.28f, 15f)
                val ry3 = Keyframe.ofFloat(0.30f, -15f)
                val ry4 = Keyframe.ofFloat(0.32f, 15f)
                val ry5 = Keyframe.ofFloat(0.34f, 0f)
                val ry6 = Keyframe.ofFloat(1f, 0f)
                rot = PropertyValuesHolder.ofKeyframe("rotation", ry0, ry1, ry2, ry3, ry4, ry5, ry6)
            }
            ChestRarity.LEGENDARY -> {
                durationMs = 1250L // Biraz yavaşlatıldı
                val ty0 = Keyframe.ofFloat(0f, 0f)
                val ty1 = Keyframe.ofFloat(0.25f, 0f)
                ...
                // Saat yönü ve tersi daha şiddetli sallanma (2D titreşim)
                val ry0 = Keyframe.ofFloat(0f, 0f)
                val ry1 = Keyframe.ofFloat(0.25f, 0f)
                val ry2 = Keyframe.ofFloat(0.27f, 25f)
                val ry3 = Keyframe.ofFloat(0.29f, -25f)
                val ry4 = Keyframe.ofFloat(0.31f, 25f)
                val ry5 = Keyframe.ofFloat(0.33f, -25f)
                val ry6 = Keyframe.ofFloat(0.35f, 0f)
                val ry7 = Keyframe.ofFloat(1f, 0f)
                rot = PropertyValuesHolder.ofKeyframe("rotation", ry0, ry1, ry2, ry3, ry4, ry5, ry6, ry7)
            }
        }
