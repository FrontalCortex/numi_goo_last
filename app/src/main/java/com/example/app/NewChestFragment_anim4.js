...
const newFunc = `private fun startIdleAnimation() {
        ...
        when (currentRarity) {
            ...
            ChestRarity.EPIC -> {
                ...
                // Daha yavaş ve daha az açılı sallanma (5 derece)
                val ry0 = Keyframe.ofFloat(0f, 0f)
            ...
            ChestRarity.LEGENDARY -> {
                ...
                // Daha yavaş, biraz daha fazla açılı sallanma (10 derece)
                val ry0 = Keyframe.ofFloat(0f, 0f)
                val ry1 = Keyframe.ofFloat(0.25f, 0f)
                val ry2 = Keyframe.ofFloat(0.28f, 10f)
                val ry3 = Keyframe.ofFloat(0.30f, -10f)
                val ry4 = Keyframe.ofFloat(0.32f, 10f)
                val ry5 = Keyframe.ofFloat(0.35f, 0f)
